...
import { LiaLinkedin, LiaLongArrowAltRightSolid, LiaWhatsapp } from "react-icons/lia";
      ...
      <form>
        ...
        <div className="mt-4 max-md:">
          <div className="input-wrapper">
            ...
            <input type="text" id="email" name="text" className="input" placeholder="info@gmail.com" />
