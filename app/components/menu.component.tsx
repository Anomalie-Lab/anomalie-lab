...
function MenuComponent() {
  ...
  return (
    <>
      ...
      <motion.menu ref={ref} initial={{ opacity: 0, display: "none" }} animate={menu ? { opacity: 1, display: "flex" } : { opacity: 0, display: "none" }} transition={{ duration: menu ? 0.5 : 0.25, delay: menu ? 0.5 : 0 }} className="flex flex-col gap-20 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 text-white hidden max-md:flex">
        <li>
      ...
      <motion.ul ref={ref} initial={{ opacity: 0, display: "none" }} animate={menu ? { opacity: 1, display: "flex" } : { opacity: 0, display: "none" }} transition={{ duration: menu ? 0.5 : 0.25, delay: menu ? 0.5 : 0 }} className="p-6 justify-between w-full items-center fixed bottom-0 left-1/2 -translate-x-1/2 z-50 text-white/50 hidden max-md:flex">
        <li>
      ...
      <motion.div ref={ref} initial={{ opacity: 0, display: "none" }} animate={menu ? { opacity: 1, display: "flex" } : { opacity: 0, display: "none" }} transition={{ duration: menu ? 0.5 : 0.25, delay: menu ? 0.5 : 0 }} className="justify-between items-center fixed top-[53px] right-[14px] z-50 text-white/50 hidden max-md:flex">
