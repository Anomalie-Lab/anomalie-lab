  ...
  return (
    <section id="indications" className="relative mt-64">
      ...
      <div className="absolute bottom-0 right-9 z-50 max-lg:bottom-6 group">
        <button className="swiper-button-next button-next-indication p-7 group-hover:rotate-45 duration-300 bg-white text-4xl border-2 rounded-full relative duration-400 ease-linear hover:bg-black hover:text-white max-md:p-2 max-md:text-2xl" aria-label="Next Slide">
