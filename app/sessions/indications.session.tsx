...
function Indication({ slide }: { slide: { feedback: string; name: string; social: string; href: string; job: string } }) {
  return (
    <div className="flex flex-col gap-8 mt-32 w-full">
      <Image src="/aspas.png" alt="aspas" width={100} height={100} />
      <p className="text-4xl font-medium max-w-[700px]">{slide.feedback}</p>
...
export function IndicationsSession() {
  const slides = [
    { feedback: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text", name: "RAUL GUSTAVO", social: "@RAULHGUSTAVO", href: "#", job: "CEO AMAZON" },
    { feedback: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text", name: "RAUL GUSTAVO", social: "@RAULHGUSTAVO", href: "#", job: "CEO AMAZON" },
    { feedback: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text", name: "RAUL GUSTAVO", social: "@RAULHGUSTAVO", href: "#", job: "CEO AMAZON" },
    { feedback: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text", name: "RAUL GUSTAVO", social: "@RAULHGUSTAVO", href: "#", job: "CEO AMAZON" },
    { feedback: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text", name: "RAUL GUSTAVO", social: "@RAULHGUSTAVO", href: "#", job: "CEO AMAZON" },
  ...
  return (
    <section className="relative">
      <h2 className="font-bold text-4xl w-full text-end">INDICATIONS</h2>
