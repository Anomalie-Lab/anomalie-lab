  ...
  return (
    <section className="uppercase font-semibold max-md:min-h-[90vh]">
      <motion.h1
        ...
        className="text-[230px] h-56 flex relative items-center right-4  justify-between max-md:text-7xl max-md:h-fit max-md:right-1.5 max-md:mt-14"
      >
        <span className="drop-shadow-2xl">Lab.</span>
      </motion.h1>
      <div
        className="bg-[url('/artHome.jpg')] shadow-2xl
 h-96 bg-cover bg-center z-20 relative max-md:h-72 max-sm:h-56"
      ...
      <div className="flex items-center justify-between max-md:items-start max-md:flex-col">
        <motion.h1
          ...
          animate={isInView1 ? { opacity: 1, y: 0 } : { opacity: 0, y: -150 }}
          transition={{ duration: 0.5, delay: 0.5 }}
