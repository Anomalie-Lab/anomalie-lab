  ...
  return (
    <section className="uppercase font-semibold max-md:min-h-[90vh]">
      ...
      <div className="flex items-center justify-between max-md:items-start max-md:flex-col overflow-hidden">
        ...
        <Link
          href="#"
          className="cursor-pointer relative group rounded-full flex"
        >
          <span className="absolute pl-12 pr-32 top-1/2 -translate-y-1/2 text-nowrap group-hover:-right-[0px] right-20 p-5 duration-300 ease-linear border rounded-full -z-10 text-black/30 group-hover:text-black group-hover:border-black">
            {trans.t("CONTACT US")}
          </span>
