...
export function BuilderSession() {
  ...
  return (
    <section id="contacts" className="mt-24  h-[600px] flex items-end hover-card group max-md:mb-24 max-md:mt-0" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{ perspective: "1000px" }}>
