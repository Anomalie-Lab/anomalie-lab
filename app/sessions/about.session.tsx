...
const AnimatedTabContent: React.FC<{ children: React.ReactNode; title: string }> = ({ children, title }) => {
  ...
  return (
    <motion.div ref={ref} initial={{ opacity: 0 }} animate={isInView ? { opacity: 1 } : { opacity: 0 }} transition={{ duration: 2 }} className="mx-auto">
      <h3 className="text-4xl w-1/2 text-center mx-auto font-bold pt-12 max-md:text-3xl max-md:pt-2 max-md:w-2/3 mt-12">{title}</h3>
